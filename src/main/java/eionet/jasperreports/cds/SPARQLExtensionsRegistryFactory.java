 ...
 * @author Søren Roug
 */
public class SPARQLExtensionsRegistryFactory implements ExtensionsRegistryFactory {
        ...
        new ExtensionsRegistry() {
            public <T> List<T> getExtensions(Class<T> extensionType) {
                if (JRQueryExecuterFactoryBundle.class.equals(extensionType)) {
                    return (List<T>) Collections.singletonList((Object) SPARQLQueryExecuterFactoryBundle.getInstance());
                }
                return null;
            }
        };
